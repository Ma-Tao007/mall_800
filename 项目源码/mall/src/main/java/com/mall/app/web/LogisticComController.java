...
public class LogisticComController {
	...
	public boolean addLogisticCom(String comName) {
		...
		return impl.addLogisticCom(comName);
	}
	...
	public boolean removeLogisticCom(@RequestParam("lids[]")String[] lids) {
		
		return impl.removeLogisticCom(lids);
	}
	...
	public int getCountLogisticCom() {
		...
		return impl.getCountLogisticCom();
	}
}
