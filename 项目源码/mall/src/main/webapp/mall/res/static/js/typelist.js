                                ...
                                success: function(res){
                                    ...
                                    res.forEach(function(item){//显示每个商品
                                        ...
                                        var newText =
                                            ...
                                            item.productImage+ "'"+ //此处应当是item.imge*********************************************************显示图片、
                                            "/></div>"+
                                            "<p class='title'>" +
...
//					    <div class="layui-col-xs6 layui-col-sm3">
//					      <div class="list-detail">
//					        <div class="img"><img src="../res/static/img/paging_img2.jpg"></div>
//					        <p class="title"><a href="detail.html">森系小清新四件套</a></p>
//					        <p><span class="price">￥200</span><span>1266</span>人付款</p>
//					      </div>
//					    </div>
                                }
                            })
