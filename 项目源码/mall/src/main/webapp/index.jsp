	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-right">
				<li class="layui-nav-item">欢迎光临，登录</li>
			...
			<div class="layui-side-scroll">
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-id="4" data-title="订单信息管理"
									data-url="jsp/orderList.jsp" class="site-demo-active"
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-id="5" data-title="物流信息管理"
									data-url="jsp/wuliuList.jsp" class="site-demo-active"
									data-type="tabAdd">物流信息管理</a>
							</dd>
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-id="6" data-title="客户信息管理"
									data-url="jsp/customerList.jsp" class="site-demo-active"
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test">
					<li class="layui-nav-item"><a class="" href="javascript:;">系统信息管理</a>
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-id="1" data-title="商家信息管理"
									data-url="jsp/userList.jsp" class="site-demo-active"
									data-type="tabAdd">商家信息管理</a>
							</dd>
